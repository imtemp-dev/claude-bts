...
// The gates are only as good as what gets written. `jig recipe log` is
...
func TestRecipeLog_StampsContentHashes(t *testing.T) {
	...
	writeProjectFile(t, root, ".jig/specs/recipes/r-h01/draft.md", "draft body v1\n")
	writeProjectFile(t, root, ".jig/specs/recipes/r-h01/verification.md",
		"# Verification\nround 1\n")

	runRecipeLog(t, root, "r-h01", "--iteration", "1", "--critical", "0",
		"--doc", filepath.Join(".jig", "specs", "recipes", "r-h01", "draft.md"),
		"--scope", "full")
	...
	writeProjectFile(t, root, ".jig/specs/recipes/r-h01/draft.md", "draft body v2\n")
...
func TestRecipeLog_StampsVerificationHashWithoutDoc(t *testing.T) {
	...
	writeProjectFile(t, root, ".jig/specs/recipes/r-h02/verification.md", "# V\n")
